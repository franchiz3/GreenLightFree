...
namespace SimpleHealthBar_SpaceshipExample
{
	public class PlayerController : MonoBehaviour
	{
		...
		void Aiming ()
		{
            ...
            //change made here to vector3 on mouse position to get rid of error
			overheatVisual.position = (Vector3)Input.mousePosition - ( Vector3 )( overheatVisual.sizeDelta / 2 );
