...
public class _design_control : MonoBehaviour {
    ...
    private void Start()
    {
        //loading ball preferences
        hud_control hud = GameObject.Find("_GameControl").GetComponent<hud_control>();
        _Game_Control.instance._sprt_trajectory = _trajectory_points_textures[PlayerPrefs.GetInt("trajectoryColor")];
        hud._trajectory_default.sprite = _trajectory_points_textures[PlayerPrefs.GetInt("trajectoryColor")];
        _Game_Control.instance._sprt_player = _player_textures[PlayerPrefs.GetInt("playerColor")];
        hud._player_default.sprite = _player_textures[PlayerPrefs.GetInt("playerColor")];
        _Game_Control.instance._ball_material = _ball_materials[PlayerPrefs.GetInt("ballColor")]._material_ball;
        hud._ballicon_default.sprite = _ball_materials[PlayerPrefs.GetInt("ballColor")]._icon;
    }
    //---------------------------------------
	...
	public void _update_selection(Image _img){
		...
		if (_selectmode == 0) {
            ...
            PlayerPrefs.SetInt("ballColor", _t);
		} else if (_selectmode == 1) {
            ...
            PlayerPrefs.SetInt("playerColor", _t);
        }
        else{
            ...
            PlayerPrefs.SetInt("trajectoryColor", _t);
        }
